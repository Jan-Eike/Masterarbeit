...
%% Ihr Studienfach
\subject{Artificial Intelligence and Data Science}

%% Beginn- und Abgabedaten der Arbeit
\begindate{05.~Juni~2023} % Beginn
\duedate{05.~Dezember~2023} % Abgabe

%% Erst- und Zweitgutachter
\firstexaminer{Univ.-Prof.~Dr.~L.~Kallmeyer}
\secondexaminer{MA~Regina~Stodden}
...
\usepackage{makecell} % for tables with new lines
\usepackage{array,multirow} % also for tables
\usepackage{csquotes} % for quotes
\usepackage{dirtytalk} % für quotes
\usepackage{siunitx} % pretty print numbers
